...
export const SPACE_CHARACTER_CONFIGS: SpaceCharacterConfig[] = [
  ...
  {
    id: "spaceStudent03",
    label: "Estudiante al lado derecho del nino",
    modelUrl: `${SPACE_CHARACTER_MODEL_ROOT}space-student-03.glb`,
    modelUrlCandidates: [
      `${SPACE_CHARACTER_MODEL_ROOT}space-student03.glb`,
      `${SPACE_CHARACTER_MODEL_ROOT}student03.glb`
    ],
    position: new Vector3(2.85, 0, -0.2),
    rotationY: lookAtXZ(new Vector3(2.85, 0, -0.2), activityParticipantTarget),
    rotationOffsetY: 0,
    ...
    targetHeight: 1.34,
    facesActivityParticipant: true,
    fallbackColor: new Color3(0.48, 0.78, 0.62)
  }
];
