...
interface VisualDiscriminationDistractorOptions {
  ...
  onDistractorEvent?: (event: VisualDiscriminationDistractorEvent) => void;
}

export interface VisualDiscriminationDistractorEvent {
  distractorId: string;
  type: Exclude<BlockType, "none">;
  startedAt: number;
  endedAt: number;
}
...
export class VisualDiscriminationDistractorManager {
  ...
  private readonly onDistractorEvent:
    | ((event: VisualDiscriminationDistractorEvent) => void)
    | null;
  ...
  private updateActiveEvent(
    ...
    this.onDistractorEvent?.({
      distractorId,
      type: this.activeEvent.distractorType as Exclude<BlockType, "none">,
      startedAt,
